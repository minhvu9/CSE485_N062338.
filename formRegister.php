...
<body style="height:1324px;width:1000px;padding:0px 150px 0px 150px;background:#f1cbf1;border:groove;">
    ...
    <div class="register-photo" style="width:1000px;">
        <div class="form-container" style="width:627px;">
            <div class="image-holder" style="width:208px;"></div>
            <form method="post">
                <h2 class="text-center"><strong>Hello New Admin</strong></h2>
                ...
                <div class="form-group"><button class="btn btn-primary btn-block" type="submit" style="height:41px;">Sign Up</button></div><a href="#" class="already">You already have an account? Login here.</a></form>
        </div>
    </div>
