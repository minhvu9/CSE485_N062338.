...
<body style="height:0px;width:1000px;padding:0px 150px 0px 150px;background:#f1cbf1;border:groove;">
    <header id="top" style="width:1003px;">
        <div class="container" id="Banner" style="width:1000px;height:120px;">
            <div class="row">
                <div class="col"><img src="assets/img/banner2.jpg" style="width:688px;height:118px;"></div>
                <div class="col-lg-3" id="NgonNgu">
                    <p>Ngôn Ngữ</p>
                    <div class="row" id="Langu_Viet" style="width:244px;height:50px;">
                        <div class="col-lg-5"><img src="assets/img/VN.png" style="width:39px;height:28px;"></div>
                        <div class="col"><a href="#">Việt Nam</a></div>
                    </div>
                    <div class="row" id="Langu_Eng" style="width:244px;height:50px;">
    ...
    <div class="login-clean" style="width:1000px;">
        <form method="post">
            <h2 class="sr-only">Login Form</h2>
            <div class="illustration"><i class="icon ion-ios-navigate"></i></div>
            <div class="form-group"><input class="form-control" type="email" name="email" placeholder="Email"></div>
            <div class="form-group"><input class="form-control" type="password" name="password" placeholder="Password"></div>
            <div class="form-group"><button class="btn btn-primary btn-block" type="submit" style="width:194px;height:45px;">Log In</button></div><a href="#" class="forgot">Forgot your email or password?</a></form>
    </div>
