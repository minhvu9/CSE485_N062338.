...
<body style="height:2878px;width:1000px;padding:0px 150px 0px 150px;background:#f1cbf1;border:groove;">
    ...
    <div class="container" id="game" style="width:1000px;height:776px;">
        <div class="row" style="width:1000px;height:10px;"></div>
        <div class="row" id="top_game" style="width:1000px;">
            <div class="col" id="tenGame">
                <p id="TenGame" style="height:59px;color:rgb(238,33,20);font-size:24px;">Rồng đen</p>
            </div>
            <div class="col" id="imgGame"><img src="assets/img/p37.gif" style="width:147px;height:122px;"></div>
            <div class="col" id="inforGame"></div>
        </div>
        <div class="row"></div>
    </div>
