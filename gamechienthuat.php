...
<body style="height:1500px;width:1300px;padding:0px 150px 0px 150px;background:#f1cbf1;border:groove;">
    ...
    <div class="container" id="Container3" style="height:484px;width:1001px;">
        <div class="row" id="row1_Cont3" style="height:30px;width:1000px;">
            <div class="col-lg-2">
                <p style="font-size:16px;color:rgb(228,12,12);">CHIẾN THUẬT</p>
            </div>
            <div class="col"></div>
        </div>
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="col"><img src="assets/img/BóngĐá1.jpg" style="width:150px;"></div>
        ...
        <div class="row">
            ...
            <div class="col"><img src="assets/img/daovang80-size-111x111-znd.jpg" style="width:150px;"></div>
            ...
            <div class="col"><img src="assets/img/p22.jpg" style="width:150px;"></div>
        </div>
