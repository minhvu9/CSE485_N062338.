...
<body style="height:1500px;width:1300px;padding:0px 150px 0px 150px;background:#f1cbf1;border:groove;">
            ...
            <div class="row">
                <div class="col" style="width:375px;">
                    <div class="row" id="row1">
                        <div class="col" id="col_1" style="width:181px;"><button class="btn btn-primary" type="button" id="DangNhap" style="width:128px;">Đăng nhập</button></div>
                        <div class="col-lg-6" id="col_2" style="width:184px;"><button class="btn btn-primary" type="button" id="DangKy" style="height:30px;width:136px;">Đăng ký</button></div>
                    </div>
    ...
    <header id="header_icon1" style="width:1007px;height:66px;">
        <div class="container" id="Cont_Menu" style="width:999px;height:65px;">
            <div class="row" id="Row_Menu" style="height:82px;width:965px;">
                <div class="col-lg-2" id="TrangChu" style="width:115px;"><button class="btn btn-primary" type="button" id="But_TrangChu" style="width:121px;height:42px;background-color:rgb(255,15,0);float:left;padding:0px;"><i class="fa fa-home" style="height:14px;margin:1px;font-size:21px;padding:0px;"></i>Trang Chủ</button></div>
                <div
                    class="col" id="He2_Gamehay" style="height:82px;width:114px;"><button class="btn btn-primary" type="button" id="But_GameHay" style="width:103px;height:44px;background-color:rgb(250,255,0);color:rgb(255,255,255);">Game Hay</button></div>
            <div class="col" id="He2_GameHot" style="width:121px;"><button class="btn btn-primary" type="button" id="But_GameHot" style="width:96px;height:43px;background-color:rgb(66,255,0);">Game Hot</button></div>
            <div class="col" id="He2_GameMoi" style="width:119px;"><button class="btn btn-primary" type="button" id="But_GameMoi" style="width:98px;height:43px;">Game Mới</button></div>
            <div class="col" id="He2_GameVui" style="width:120px;"><button class="btn btn-primary" type="button" id="But_GameVui" style="width:101px;height:44px;background-color:rgb(255,0,230);">Game Vui</button></div>
            <div class="col" id="He2_GameTai" style="width:112px;"><button class="btn btn-primary" type="button" id="But_GameTN" style="width:113px;height:44px;background-color:rgb(112,0,255);font-size:14px;">Game Tải Nhiều</button></div>
            <div class="col" id="He2_GameSolo" style="width:195px;"><button class="btn btn-primary" type="button" id="GameSoLo" style="width:106px;height:44px;padding:1px;background-color:rgb(213,84,43);color:#ffffff;font-size:18px;">Game Solo</button></div>
        </div>
        </div>
    </header>
    ...
    <div class="container" id="Container3" style="height:484px;width:1001px;">
        <div class="row" id="row1_Cont3" style="height:30px;width:1000px;">
            <div class="col-lg-2">
                <p style="font-size:16px;color:rgb(176,21,11);">GAME TẢI NHIỀU</p>
            </div>
            <div class="col"></div>
        </div>
        <div class="row">
            <div class="col"><img src="assets/img/chi-huy-thien-ha.png" style="width:150px;"></div>
            <div class="col"><img src="assets/img/chu-khi-buon-118.png" style="width:150px;"></div>
            <div class="col"><img src="assets/img/co-caro-2-nguoi.png" style="width:150px;"></div>
            <div class="col"><img src="assets/img/cong-nhan-cho-hang-6.png" style="width:150px;"></div>
            <div class="col"><img src="assets/img/garen-om-tru.png" style="width:150px;"></div>
        </div>
        <div class="row">
            <div class="col"><img src="assets/img/gau-bong-diet-zombie.png" style="width:150px;"></div>
            <div class="col"><img src="assets/img/hoa-qua-noi-gian-2.1.png" style="width:150px;"></div>
            <div class="col"><img src="assets/img/nguoi-que-dai-chien-hay.png" style="width:150px;"></div>
            <div class="col"><img src="assets/img/lego-tim-sao.png" style="width:150px;"></div>
            <div class="col"><img src="assets/img/lien-quan-online.png" style="width:150px;"></div>
        </div>
        <div class="row">
            <div class="col"><img src="assets/img/Game_AngryBird.jpg" style="width:150px;"></div>
            <div class="col"><img src="assets/img/dieu-khien-may-bay.png" style="width:150px;"></div>
            <div class="col"><img src="assets/img/gunny-size-111x111-znd.jpg" style="width:150px;"></div>
            <div class="col"><img src="assets/img/robot-ban-sung-105-size-111x111-znd.jpg" style="width:150px;"></div>
            <div class="col"><img src="assets/img/robot-khung-long-khong-lo-105-size-111x111-znd.jpg" style="width:150px;"></div>
        </div>
                ...
                <div class="row" id="ThongTin" style="height:143px;">
                    <div class="col">
                        ...
                        <div class="row" style="height:45px;">
                            <div class="col"><a href="#">Sđt liên hệ</a></div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="row" style="height:44px;">
                            <div class="col"><a href="#">Giới thiệu</a></div>
                        </div>
                        <div class="row" style="height:43px;">
                            <div class="col"><a href="#">Chính sách</a></div>
                        </div>
                        <div class="row" style="height:38px;">
                            <div class="col"><a href="#">Điều khoản liên hệ</a></div>
                        </div>
                    </div>
                </div>
            </div>
